...
const EmployerProfileSection= () => {
  ...
  return (
    <div className="min-h-screen bg-white text-[#161811] flex flex-col" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-12">
        ...
        {/* Page Title */}
        <div className="mb-10">
          <h1 className="text-3xl font-bold mb-3 text-[#161811]">Edit <span className='text-[#8ad007]'>Employer</span> Profile.</h1>
        </div>
 ...
 <div className="mb-5">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 pb-16">
            ...
            className="w-full sm:w-auto px-8 py-3 bg-[#8ad007] text-white font-bold rounded-xl shadow-xl shadow-[#8ad007]/20 hover:shadow-[#8ad007]/40 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 group text-sm cursor-pointer"
            >
            {loading || redirecting ? (
                    <>
